...
class ProjectController extends Controller
{
    ...
    {   
        $project = $this->projectService->showSingleProject($id); //retornar o projeto que  pertence a esse id passado como parâmentro na dashboard
    ...
    public function update(UpdateProjectRequest $request, Project $project) //public function update(UpdateProjectRequest $request)
    {
        ...
        return Redirect::route('/Projects'); //Ainda não vai pq a rota n lembro
    }
