...
export default {
    ...
    methods: {
        showProject(id) {
            Inertia.put(route('projects.show', {project: id}));
        }
    }
}
</script>
        ...
        <section class="w-full h-[calc(100vh_-_64px)] bg-no-repeat justify-around bg-[length:100vw_91vh]" style="background-image: url(../imgs/main3.png)">
            ...
            <section>
                ...
                <ul class="after:content-[''] after:bg-stone-900/[.3]  after:h-0.5 after:w-3/6 after:block after:ml-auto after:mr-auto after:mt-8" >
                    ...
                    <li  class=" pb-4 mb-4 flex items-center justify-center flex-col-reverse sm:flex-row        md:justify-evenly hover:shadow-xl mr-4 ml-4 md:ml-8 md:mr-8" v-for="p in projects.data" :key="p.id">
                        <div class="inline-block sm:w-2/5 ">
                           ...
                           <div class="mr-2 ml-2 flex items-end justify-between">
                            <p class="w-6/12 text-base">
                            Cidade: {{p.city}}<br>
                            Bairro:{{ p.neighborhood }}</p>
                            <a href="#" @click="showProject(p.id)">
